...
namespace UseScripts
{
    ...
    public class SteamLobbyManager : MonoBehaviour
    {
        ...
        void OnLobbyCreated(LobbyCreated_t result)
        {
            ...
            LobbyData.Instance.InitializeLobbyData(new CSteamID(result.m_ulSteamIDLobby), new CSteamID(result.m_ulSteamIDLobby).ToString(),SteamMatchmaking.GetLobbyOwner(LobbyData.Instance.CurrentLobbyID), false, 8);
            // UI Initialize
            MainMenuManager.Instance.LobbyUIObjects.lobbyCode.text = LobbyData.Instance.CurrentLobbyIDInString;
        ...
        void OnLobbyEntered(LobbyEnter_t result)
        {
            ...
            LobbyPlayerData.Instance.InitializeLobbyPlayerData(SteamUser.GetSteamID(), SteamFriends.GetPersonaName(),
                false);
